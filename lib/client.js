...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const s = {
      ...
      list: { flex: 1, overflowY: "auto", padding: "8px 8px 4px", display: "flex", flexDirection: "column", gap: 4 },
      // 任务行：单行结构（勾选+文字+右侧按钮两行 [发送/复制 | 颜色/删除]）
      row: { display: "flex", flexDirection: "column", gap: 2, padding: "3px 6px", borderRadius: 8, background: "transparent", border: "1px solid transparent" },
